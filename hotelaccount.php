<?php
session_start();
    if((!isset($_SESSION['id']))||($_SESSION['accountType']!='Hotel Manager'))
    {
     echo "<script>
...
<div class="sidebar">
 <a  href="welcomehotel.php">Home</a>
  ...
  <a class="active" href="hotelaccount.php">Account</a>
...
echo "Age:".$row['age']."<br>";
echo"<a href='edithotelaccount.php'> <button type='submit' class='btn btn-info'>Edit Account Details </button> </a>";
