<?php
session_start();
    if((!isset($_SESSION['id']))&&($_SESSION['acountType']!='Admin'))
    {
     echo "<script>
...
<div class="sidebar">
 <a  href="welcomeadmin.php">Home</a>
  ...
  <a class="active" href="editadminaccount.php">Edit Account</a>
...
?>
 <div class="form">
            <form onsubmit="return check(this)" action="processeditadminaccount.php" method="post" >
