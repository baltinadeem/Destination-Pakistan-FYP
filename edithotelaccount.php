<?php
session_start();
    if((!isset($_SESSION['id']))&&($_SESSION['acountType']!='Hotel Manager'))
    {
     echo "<script>
...
<title>Edit Hotel-Manager Account</title>
...
<div class="sidebar">
 <a  href="welcomehotel.php">Home</a>
  ...
  <a class="active" href="edithotelaccount.php">Edit Account</a>
...
?>
 <div class="form">
            <form onsubmit="return check(this)" action="processedithotelaccount.php" method="post" >
