<?php
session_start();
    if((!isset($_SESSION['id']))&&($_SESSION['acountType']!='Tour Operator'))
    {
     echo "<script>
...
<title>Edit Tour Operator Account</title>
...
<div class="sidebar">
 <a  href="welcometour.php">Home</a>
  ...
  <a class="active" href="edittouraccount.php">Edit Account</a>
...
?>
 <div class="form">
            <form onsubmit="return check(this)" action="processedittouraccount.php" method="post" >
