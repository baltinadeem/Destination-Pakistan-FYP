<?php
session_start();
    if((!isset($_SESSION['id']))&&($_SESSION['acountType']!='Transport Manager'))
    {
     echo "<script>
...
<title>Edit Transport-Manager Account</title>
...
<div class="sidebar">
 <a  href="welcometransport.php">Home</a>
  ...
  <a class="active" href="edittransportaccount.php">Edit Account</a>
...
?>
 <div class="form">
            <form onsubmit="return check(this)" action="processedittransportaccount.php" method="post" >
       <input type="hidden" name="id" value="<?php echo $id; ?>">
          ...
          CNIC:<input type="text" name="cnic" value="<?php echo $cnic; ?>"  required="required"/>
