<?php
session_start();
    if((!isset($_SESSION['id']))||($_SESSION['accountType']!='Transport Manager'))
    {
     echo "<script>
...
<title>Transport-Manager Account </title>
...
<div class="sidebar">
 <a  href="welcometransport.php">Home</a>
  ...
  <a class="active" href="transportaccount.php">Account</a>
...
echo "Age:".$row['age']."<br>";
echo"<a href='edittransportaccount.php'> <button type='submit' class='btn btn-info'>Edit Account Details </button> </a>";
